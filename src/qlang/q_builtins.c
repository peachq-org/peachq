 ...
 *                       wrong one; the reason is in tools/qdocs-docmap.pins.tsv.
 ...
 *                       ("x+y     +[x;y]"), "" when docsrc is or the page has none.
 *   example       str   a one-line `expr -> output` generated by RUNNING ./q
 *                       ("til 5 -> 0 1 2 3 4"), "" when the verb has no curated
 *                       example.  SPARSE by design (tools/qdocs-example.tsv).
 * doc+docsrc+syntax are re-derived by tools/qdocs-doccheck.sh; example by
